...
'''
    ...
    Parameters: nstruc: number of structures, outfile: output bulk list, a: optimized a0, c_a_ratio
    Return: 
'''
def crt_bulks(nstruc, outfile, a=5.1856, c_a_ratio=0.5527):
    bulk_list = []
    a_per = a
    ...
    for n in range(int(nstruc)):
        ...
        Ge_bulk.info["config_type"] = "betaTin"
