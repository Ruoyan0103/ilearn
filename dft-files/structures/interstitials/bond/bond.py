...
interstitial_position = np.array([0.375*a0*3, (7/12+0.5)/2*a0*3, (7/12+0.5)/2*a0*3]) #v2


interstitial_atom = Atoms('Ge', positions=[interstitial_position])
combined_structure = Ge_sup + interstitial_atom
#combined_structure = Ge_sup 
# del Ge_sup[5]
...
write('Ge.bond', combined_structure, format='lammps-data')
