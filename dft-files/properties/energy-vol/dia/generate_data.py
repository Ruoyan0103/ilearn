...
def get_struct_volume(lattice_constant):
    Ge_dia = bulk('Ge', 'diamond', a=lattice_constant, cubic=False)
    n = len(Ge_dia)
    v = Ge_dia.get_volume()                                    
    return Ge_dia, v/n
...
folder = 'Final2'
vfile = 'a-vol'
a_sat, a_end, interval = 5.2, 6.5, 0.1
