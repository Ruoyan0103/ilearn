...
def sortFile(vfile, folder, engfile, outfile):
    natoms = 1                              # modify manualy, e.g. for beta/hcp/dia=2, f/bcc=1, bc8=8, hd=4, st12=12
    volume = []
...
folder = 'Final2'
vfile = 'a-vol'
a_sat, a_end, interval = 3.9, 4.75, 0.05
